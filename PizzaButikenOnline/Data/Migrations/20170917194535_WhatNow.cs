        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AnonymousAddressId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AnonymousAddresses_AnonymousAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientDishes", x => new { x.DishId, x.IngredientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientOrderDishes", x => new { x.OrderDishId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_IngredientOrderDishes_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientOrderDishes_OrderDishes_OrderDishId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientOrderDishes_IngredientId",
                table: "IngredientOrderDishes",
                column: "IngredientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_AnonymousAddressId",
                table: "Orders",
